namespace ApiRoute.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ApiRoute.Models.ApiRouteContext>
    {
        ...
        protected override void Seed(ApiRoute.Models.ApiRouteContext context)
        {
